package com.valdroide.mycitysshopsadm.main.draw.activities.ui;
...
import com.valdroide.mycitysshopsadm.main.draw.activities.adapters.SectionsPagerAdapter;
...
public class DrawActivity extends AppCompatActivity implements Communicator {
   ...
   // @Inject
    ...
    private void initToolBar() {
        Utils.writelogFile(this, "initToolBar(DrawActivity)");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle(R.string.draw_title);
    }

    private void setupNavigation() {
        Utils.writelogFile(this, "setupNavigation(DrawActivity)");
    ...
    public void hideKeyBoard() {
        Utils.writelogFile(this, "hideKeyBoard(DrawActivity)");
    ...
    private void setPagerAdapter() {
        Utils.writelogFile(this, "setPagerAdapter(DrawActivity)");
    ...
    public void refresh(boolean isBroadcast) {
        Utils.writelogFile(this, "refresh(DrawActivity)");
        getDrawListFragment().refresh(isBroadcast);
    }

    public DrawListFragment getDrawListFragment() {
        Utils.writelogFile(this, "getDrawListFragment(DrawActivity)");
